...
def clean_features(
    ...
    if columns_to_clean is None:
        columns_to_clean = features_df.columns.tolist()
    numeric_cols = [
    ...
    # print("1) cleaned_features_df\n", cleaned_features_df.isna().sum())
    if len(numeric_cols) > 0:
        ...
        # print(num_cleaned)
        cleaned_features_df[numeric_cols] = num_cleaned
    ...
    if not strategy_cat is None:
        ...
        if len(categorical_cols) > 0:
            ...
            cleaned_features_df[categorical_cols] = cat_cleaned
    # print("2) cleaned_features_df\n", cleaned_features_df.isna().sum())
    # print("standardizer", standardizer is None)
    ...
    if not standardizer is None:
        ...
        if len(columns_to_scale) > 0:
            # print(standardizer.fit_transform(
            ...
            if fit_standardizer:
                ...
                cleaned_features_df[columns_to_scale] = standardizer.transform(
                    X=cleaned_features_df[columns_to_scale]
                )
...
def add_custom_features(
    ...
    if "CalcNumLipinskiHBA" in data_df.columns and "CalcNumLipinskiHBD" in data_df.columns and "CalcExactMolWt" in data_df.columns and "MolLogP" in data_df.columns:
