...
class MoleculeFeaturizer(object):
    ...
    def compute_properties_for_mols(
        ...
        try:
            ...
            # print('mordred_props_df\n', mordred_props_df.iloc[0,:].values.tolist(), '\n')
            ...
            if not (rdkit_props_is_all_none or mordred_props_df is None):
                ...
                if as_dataframe:
                    # print("rdkit_props_df.index", rdkit_props_df.index)
                    # print("mordred_props_df.index", mordred_props_df.index)
                    # print("pd.concat([rdkit_props_df, mordred_props_df], axis=1)\n", pd.concat([rdkit_props_df, mordred_props_df], axis=1).head(5))
